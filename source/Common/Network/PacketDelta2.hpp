...
#ifndef PACKETDELTA2_HPP
#define PACKETDELTA2_HPP
...
class PacketDelta2 : public Packet
{
public:
    ...
    PacketDelta2() : PacketDelta2(std::vector<uint8_t>()) {}
    explicit PacketDelta2(std::vector<uint8_t> rawData);
    ...
    PacketDelta2(const PacketDelta2&) = default;
    PacketDelta2(PacketDelta2&&) = default;
    PacketDelta2& operator=(const PacketDelta2&) = default;
    PacketDelta2& operator=(PacketDelta2&&) = default;
    virtual ~PacketDelta2() = default;
