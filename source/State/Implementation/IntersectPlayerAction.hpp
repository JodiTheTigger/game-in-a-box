...
#ifndef INTERSECTPLAYERACTION_HPP
...
std::vector<Intersect> IntersectPlayerAction(const Entity& primary, const std::vector<const Entity*>& targets);
...
#endif // INTERSECTPLAYERACTION_HPP
