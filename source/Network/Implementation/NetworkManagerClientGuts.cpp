...
NetworkManagerClientGuts::NetworkManagerClientGuts(
    ...
    : NetworkManagerClientGuts(network, stateManager, Clock::now)
{
}
...
void NetworkManagerClientGuts::Connect(boost::asio::ip::udp::endpoint serverAddress)
{
    // reset state please.
    myNetwork.Reset();
...
void NetworkManagerClientGuts::Disconnect()
{
    Fail("Client disconnected.");
}

void NetworkManagerClientGuts::PrivateProcessIncomming()
{
...
void NetworkManagerClientGuts::PrivateSendState()
{
    if (myConnection.IsConnected())
    {
...
void NetworkManagerClientGuts::Fail(std::string failReason)
{
...
void NetworkManagerClientGuts::DeltaReceive()
{
